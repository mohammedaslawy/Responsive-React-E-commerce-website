...
const subTitle = "Save the Time";
const title = (
    <h2 className='title'>Unlock Advanced Mastery in our <b>Exclusive <span>One-Day</span></b> Free Workshop on Sale!</h2>
);
const desc = "Limited Slots! Act Now – Ending Soon"
